...
- Compose generated resources 导入前缀，例如 `mineagent.ui_theme.generated.resources.Res` -> `agro.ui_theme.generated.resources.Res`。
...
- `oldComposeResourceRoot`：旧资源根包名前缀，例如 `mineagent`。
- `newComposeResourceRoot`：新资源根包名前缀，例如 `agro`。
